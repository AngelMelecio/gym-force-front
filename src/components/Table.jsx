            ...
            <AbsScroll vertical loading={loading} >

              {
                filteredData?.map((item, i) =>
                  <div
                    key={item['id']}
                    className='flex flex-row p-3 duration-200 hover:bg-slate-100 hover:shadow-sm hover:cursor-pointer'>
                    {// Image or icon 
                    }
                    <div className='w-16 h-16 bg-gray-400 rounded-full shadow-md total-center'
                    ...
                    <div className='flex flex-grow'>
                      <div className='w-full'>
                        ...
                        <div 
                        type="button"
                        className='relative flex items-center justify-center flex-grow h-full py-1 md:w-full md:flex-row md:justify-between'
                          onClick={() => navigate(`/${path}/${item[idName]}`)}>
                          {// Title and subtitle
                          }
                          ...
                          {/* Options */}
                          <button className='flex w-10 h-full justify-items-start md:items-center md:justify-center '
