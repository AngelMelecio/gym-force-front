...
const TicketToPrint = ({ tittle, data, onCloseModal }) => {
                                    ...
                                    <Page size={[201, 595]}>
                                        <View style={{ display: 'flex', flexDirection: 'column', width: '100%', alignItems: 'center', paddingTop:2}}>
                                            ...
                                            <View style={{ justifyContent: 'center', alignItems: 'center', marginTop: 10, width: '100%' }}>
                                                <Text style={{ fontFamily: 'Roboto', fontWeight: 400, fontSize: 10, marginBottom: 3 }}>{"Av. América #795, Moroleón, Gto."}</Text>
                                                <Text style={{ fontFamily: 'Roboto', fontWeight: 600, fontSize: 10, }}>{new Date(data.fecha).toLocaleString('es-ES')}</Text>
                                            </View>
                                            <View style={{ display: 'flex', flexDirection: 'column', marginTop: 2.5, width: '100%' }}>
                                                <View style={{ display: 'flex', flexDirection: 'column', justifyContent: 'flex-start' }}>
                                                    <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', marginVertical: 1.5 }}>
                                                        <Text style={{ fontFamily: 'Roboto', fontWeight: 600, fontSize: 9 }}>ID de la venta: </Text>
                                                        <Text style={{ fontFamily: 'Roboto', fontWeight: 400, fontSize: 9 }}>{data.idVenta}</Text>
                                                    </View>
                                                    <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', }}>
                                                        <Text style={{ fontFamily: 'Roboto', fontWeight: 600, fontSize: 9 }}>Te atendio: </Text>
                                                        <Text style={{ fontFamily: 'Roboto', fontWeight: 400, fontSize: 9 }}>{data.usuario}</Text>
                                                    </View>
                                                </View>
                                            </View>
                                            <View style={{ display: 'flex', flexDirection: 'column', width: '100%', justifyContent: 'flex-start', marginTop: 3 }}>
                                                ...
                                                {data.detallesSuscripcion?.map((dtll, i) => (
                                                    <View key={`DTLL_S_${i}`} style={{ display: 'flex', flexDirection: 'row', width: '100%', marginTop: 2 }}>
                                                        <Text style={[styles.textTable, { width: '10%', textAlign: 'center' }]}>1</Text>
                                                ...
                                                <View style={{ display: 'flex', flexDirection: 'column', width: '100%' }}>
                                                    <View style={{ display: 'flex', flexDirection: 'row', marginVertical: 3, justifyContent: 'flex-end' }}>
                                                        <Text style={{ fontFamily: 'Roboto', fontWeight: 600, fontSize: 10 }}>Total: </Text>
                                                        <Text style={{ fontFamily: 'Roboto', fontWeight: 600, fontSize: 10 }}>${(Number(data.total)).toFixed(2)}</Text>
                                                    </View>
                                                </View>
                                                {
                                                    data.detallesSuscripcion?.length > 0 && (
                                                        <View style={{ justifyContent: 'center', alignItems: 'center', marginTop: 3 }}>
                                                            <Text style={{ fontFamily: 'Roboto', fontWeight: 600, fontSize: 10, }}>{data.cliente ? data.cliente : '---'}</Text>
                                                            <Text style={{ fontFamily: 'Roboto', fontWeight: 400, fontSize: 9, marginBottom: 4 }}>{'Tu suscripción termina el:'}</Text>
                                                            <Text style={{ fontFamily: 'Roboto', fontWeight: 600, fontSize: 10, }}>{nuevaFecha(data.detallesSuscripcion[0].fechaFin).toLocaleDateString('es-ES')}</Text>
                                                        </View>
                                                    )
                                                }
